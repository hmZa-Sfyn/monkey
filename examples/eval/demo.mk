...
println(os.getwd())
println(os.runCmd("find", ".", "-name", ``\*.mk``))
//os.copyFile("./xx.mk", "./demo.mk")
...
//you must give them default values, so monkey can figure their types.
name, age = "", 1 //monkey knows 'name' is a string, 'age' is an int
